...
use "$data/diab_analytic.dta", clear
...
/*Identify first Diabetes claim date*/
gen dx_year=substr(first_diab_claim_date,1,4)
destring dx_year, replace
gen dx_month=substr(first_diab_claim_date,5,2)
...
drop els_birth_date birth_year birth_month birth_date
...
save "$out/diab_cohort_file.dta", replace
exit
